...
// velociroraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const velociroraptor ={'name' : 'velocirorapt', 'diet' : 'carnivorouss', 'weight': ' 15kg', 'length' : '1.8m' , 'period' : 'Late Cretaceous'};
...
console.log(velociroraptor.diet);
...
zooAnimals.filter(zooAnimals => zooAnimals.population < 5);
...
*/
const populationTotal = [zooAnimals.reduce((Quantity, item) =>{
  return Quantity += item.population
